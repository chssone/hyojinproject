				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-4">
									<a href="./CouponSelect.jo" class="btn btn-primary btn-block">
										쿠폰 목록 </a>
								</div>
								<div class="col-md-4">
									<a href="./CouponUpdate.jo?coupon_code=${couponDTO.coupon_code}"
										class="btn btn-warning btn-block"> 쿠폰 수정 </a>
								</div>
								<div class="col-md-4">
									<a href="./CouponDeleteView.jo?coupon_code=${couponDTO.coupon_code}"
