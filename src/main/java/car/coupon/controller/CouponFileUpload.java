...
public class CouponFileUpload extends HttpServlet {
	private static Log log = LogFactory.getLog(CouponFileUpload.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(filename == null) { response.sendRedirect("./view/coupon/coupon_file_upload.jsp");
		return;
		}
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/view/coupon/coupon_file_download.jsp");
